...
import { SPECIALEVENT_FEATURE_TOGGLE } from '~/constants/config'
import SpecialEvent from '~/components/homepage/special-event'
...
export default async function Home() {
  ...
  return (
    <main className={styles.main}>
      ...
      {SPECIALEVENT_FEATURE_TOGGLE === 'true' && <SpecialEvent />}
